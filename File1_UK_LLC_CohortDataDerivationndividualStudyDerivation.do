...
clonevar employment_status_alt = cg_employment_stat
**** 
tab econ_act 
...
tab1 cohort_id   employment_status_main employment_status_alt econ_act covid_sr age_main age_alt 
tab1 sex education education_bin ethnicity  ethnicity1 country country_main country_alt hh_comp nssec7 sr_health keyworker shielding  mental_health


keep llc_0010_stud_id cohort_id  study_selection  age_selection employment_selection survey_main survey_alt employment_status_main employment_status_alt econ_act covid_sr age_main age_alt sex education education_bin ethnicity ethnicity_bin ethnicity1 country country_main country_alt hh_comp nssec7 sr_health keyworker shielding  mental_health




save "$destination\USoc_flowchart_sample_26Apr23.dta", replace
...
keep llc_0010_stud_id bd10achq1 bd10anvq1 bd10bmi bd10bmic bd10cns8 bd10cnsscc bd10cnssec bd10cntry bd10ecact bd10emwb bd10enfa bd10genh bd10hnvq bd10mbmi bd10mbmic bd10nvq1 bd10wemwb bd10mal bd10malg  
...
use  "$source\bcs70_covid_w3_v0001_20211101.dta", clear
merge 1:1 llc_0010_stud_id using "$source\bcs70_covid_w2_v0001_20211101.dta", gen(_merge2)
merge 1:1 llc_0010_stud_id using "$source\bcs70_covid_w1_v0001_20211101.dta", gen(_merge1)
merge 1:1 llc_0010_stud_id using "$source\BCS70_basic_demographic_v0001_20211101.dta", gen(_demog)
merge 1:1 llc_0010_stud_id using "$destination\core_bcs10_vars.dta", gen(_core)
...
* Files to keep 
keep /// 
llc_0010_stud_id cohort_id  cw3_enddated cw3_enddatem study_selection age_selection employment_selection  employment_status econ_act covid_sr age sex education education_bin ethnicity ethnicity1 ethnicity_bin country hh_comp nssec7 sr_health keyworker mental_health shielding


save  "$destination\BCS70_flowchart_sample_26Apr23.dta" , replace 
...
use  "$source\nextstep_covid_w3_v0001_20211101.dta", clear
merge 1:1 llc_0010_stud_id using "$source\nextstep_covid_w2_v0001_20211101.dta", gen(_merge2)
merge 1:1 llc_0010_stud_id using "$source\nextstep_covid_w1_v0001_20211101.dta", gen(_merge1)
merge 1:1 llc_0010_stud_id using "$source\NEXTSTEP_ns1_family_background_v0001_20211101.dta", gen(_mergefamilybck) keepusing(w1ethgrpyp)
merge 1:1 llc_0010_stud_id using "$source\NEXTSTEP_basic_demographic_data_v0001_20211101.dta", gen(_merge_demo)
merge 1:1 llc_0010_stud_id using "$source\NEXTSTEP_ns8_derived_v0001_20211101.dta", gen(_merge_derived) keepusing(w8dghqsc)
...
recode  ns_ethnic (1 = 1 "White") (2 = 4 "Mixed") (3/5= 2 "Asian") (6/7 =3 "Black") (8 = 5 "Other")  , gen(ethnicity)
label variable ethnicity "Ethnicity Broad"
...
save  "$destination\nextsteps_flowchart_sample_23Apr23.dta" , replace 
...
merge 1:1 llc_0010_stud_id using "$source\ncds58_covid_w1_v0001_20211101.dta", gen(_merge1)
merge 1:1 llc_0010_stud_id using "$source\NCDS58_basic_demographic_v0001_20211101.dta" , gen(_merge_demo)
merge 1:1 llc_0010_stud_id using "$destination\ncds9_mental_health.dta" , gen(_merge_mental)
...
tab1 employment_status econ_act age covid_sr sex education education_bin ethnicity ethnicity1 ethnicity_bin country hh_comp nssec7 sr_health keyworker mental_health shielding
...
save  "$destination\NCDS_flowchart_sample_23Apr23.dta" , replace 
